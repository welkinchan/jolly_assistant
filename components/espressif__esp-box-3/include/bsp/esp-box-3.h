...
/* Audio */
#define BSP_I2S_SCLK          (GPIO_NUM_17) // >i2s_sclk 4,5
#define BSP_I2S_MCLK          (GPIO_NUM_2) // >i2s_mclk 4,5
#define BSP_I2S_LCLK          (GPIO_NUM_45) // >i2s_lrck 3,4,5
#define BSP_I2S_DOUT          (GPIO_NUM_15) // To Codec ES8311  // >i2s_codec_dsdin 5
#define BSP_I2S_DSIN          (GPIO_NUM_16) // From ADC ES7210  // >i2s_adc_sdout 4
#define BSP_POWER_AMP_IO      (GPIO_NUM_46) // >pa_ctrl 3,5
