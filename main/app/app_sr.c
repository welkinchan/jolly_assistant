...
static void audio_feed_task(void *arg)
{
    ...
    int feed_channel = 3;
    ESP_LOGI(TAG, "CWG=====================audio_chunksize of audio_record_save: %d", audio_chunksize);
...
esp_err_t app_sr_start(bool record_en)
{
    ...
    //cwg==20240423
    ret_val = xTaskCreatePinnedToCore(&sr_handler_task, "SR Handler Task", 12 * 1024, NULL, 5, &g_sr_data->handle_task, 0);
